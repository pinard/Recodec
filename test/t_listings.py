...
'''
        fragments = []
        listings.list_concise_charset('latin-1', 10, fragments.append)
...
'''
        fragments = []
        listings.list_concise_charset('latin-1', 16, fragments.append)
        self.assertEqual(''.join(fragments), output)
...
'''
        fragments = []
        listings.list_concise_charset('latin-1', 8, fragments.append)
        self.assertEqual(''.join(fragments), output)
...
'''
        fragments = []
        listings.list_full_charset('latin-1', fragments.append)
        self.assertEqual(''.join(fragments), output)
